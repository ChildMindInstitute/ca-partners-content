...
\begin{flushleft}\includegraphics[width=0.33\linewidth]{downloadFigs4latex_ca_partners_applet_codebook/screen_after_bedtime_headerImg} \end{flushleft}
...
\begin{flushleft}\includegraphics[width=0.33\linewidth]{downloadFigs4latex_ca_partners_applet_codebook/socialmedia_fall_asleep_headerImg} \end{flushleft}
